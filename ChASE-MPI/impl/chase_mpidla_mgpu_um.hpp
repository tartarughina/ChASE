...
// Overloaded functions where type of dA and dB are different
...
public:
    ...
    // HAS_GPU
    {
        ...
        cout << "diag_off_size_ = " << diag_off_size_ << endl;
        cout << d_off_m_ << " " << d_off_n_ << endl;
        cout << d_off_n_ << " " << d_off_m_ << endl;
        cout << off_m << endl;
        cout << off_n << endl;
    ...
    {
        // should it be replaced with a memcpy as the data has been allocated
        // with UM?
...
//     cudaMemcpy(w, d_w_, n * n_ * sizeof(T), cudaMemcpyDeviceToHost));
    ...
    void LanczosDos(std::size_t idx, std::size_t m, T* ritzVc) override
    {
        ...
        // Change ritzVc to a managed pointer
